...
We manually label the \hmail (2009) dataset~\cite{miessler_hotmail_2009} and machine-label the \lizardsquad (2015) dataset. We are also in the process of fully labelling the Fortinet (2022) dataset~\cite{miessler_fortinet_2021}. The dataset itself is the key contribution of this chapter, and we discuss many implications in Section~\ref{sec::passwordninja::discussion}. In Section~\ref{sec::chp4::results}, we provide the results of an analysis on the \hmail dataset and consequently list a more comprehensive set of transformations and structures that can be applied to PSMs such as \zxcvbn.
