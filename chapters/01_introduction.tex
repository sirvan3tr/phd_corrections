...
\paragraph{Server-side Security.} Data leaks often contain large amounts of users’ PII and password information; this leads to credential stuffing attacks (CSAs), impersonation, and identity theft. We design and implement \deeid, which overcomes the problem of poor credential storage by using a zero-knowledge proof system and a dynamic system in which many organisations can issue identities.
...
\begin{figure}
\centering
\includegraphics[scale=0.5]{figs/summary_diagram.pdf}
...
\textit{Five Word Password Composition Policy} is the result of Chapter~4. \textit{Protecting Users from Compromised Browsers and Form Grabbers} is the result of Chapter~7.